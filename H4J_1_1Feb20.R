...
# Hint: Always remember the row ID. It may need to duplicate if there are multiple charges!
...
# Can you use Relational operators to determine which charges were resolved neither through a plea nor trough a trial?
...
# excludes duplicate ID variable
...
# To look specifically within a column of a dataframe: df$colname
